...
const format = function (f) {
  ...
  if (f[7] !== "") {
    data["名称"]["画像"] = `https://www.houjin-bangou.nta.go.jp/image?imageid=${
      f[7]
    }`;
  }
  ...
  if (f[9] !== "") {
    ...
    if (f[12].length > 0) {
      a["画像"] = `https://www.houjin-bangou.nta.go.jp/image?imageid=${f[12]}`;
    }
    data["住所"].push(a);
  }
  ...
  if (f[16] !== "") {
    ...
    if (f[17].length > 0) {
      a["画像"] = `https://www.houjin-bangou.nta.go.jp/image?imageid=${f[17]}`;
    }
    data["住所"].push(a);
  }
